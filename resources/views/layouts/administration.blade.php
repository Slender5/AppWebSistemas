	...
	<div class="contenedor-cuerpo">
		...
		<div class="contenedor-menu">
			...
			<ul class="menu">
				...
				<li><a href="/admin"><i class="icono izquierda fa fa-home"></i>Inicio<i class=" icono derecha fa fa-chevron-down"></i></a>
					<ul>
						<li><a href="/slider"><i class="icono izquierda fab fa-slideshare"></i>Slider</a></li>
						<li><a href="/noticias-admin"><i class="icono izquierda far fa-newspaper"></i>Noticias</a></li>
						<li><a href="/calendario"><i class="icono izquierda far fa-calendar-alt"></i>Calendario</a></li>
					</ul>
				</li>
...
<!------------------------------------------------------------------ FOOTER ---------------------------------------------------------->
	...
	<script src="{{ asset('js/btn-cargar.js')}}"></script>
</body>
